...
* `C2D_BUFFER_DURATION` is a predefined buffer used for checking order and provider fees validity prolonging the event timestamp property. Expressed in number of seconds, defaults to 120.
