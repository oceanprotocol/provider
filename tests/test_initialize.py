...
def test_initialize_on_bad_url(client, publisher_wallet, consumer_wallet, web3):
    ...
    logger.info(f"test1_start_timestamp: {test1_start_timestamp}")
    ...
    logger.info(f"test1_end_timestamp: {test1_end_timestamp}")
    logger.info(f"test1 duration: {test1_end_timestamp - test1_start_timestamp}")
...
def test_initialize_on_ipfs_url(client, publisher_wallet, consumer_wallet, web3):
    ...
    logger.info(f"test2_end_timestamp: {test2_end_timestamp}")
    logger.info(f"test2 duration: {test2_end_timestamp - test2_start_timestamp}")


@pytest.mark.integration
def test_initialize_on_disabled_asset(client, publisher_wallet, consumer_wallet, web3):
    test3_start_timestamp = datetime.now()
    logger.info(f"test3_start_timestamp: {test3_start_timestamp}")
    ...
    logger.info(f"test3_end_timestamp: {test3_end_timestamp}")
    logger.info(f"test3 duration: {test3_end_timestamp - test3_start_timestamp}")


@pytest.mark.integration
def test_initialize_on_unlisted_asset(client, publisher_wallet, consumer_wallet, web3):
    test4_start_timestamp = datetime.now()
    logger.info(f"test4_start_timestamp: {test4_start_timestamp}")
    ...
    logger.info(f"test4_end_timestamp: {test4_end_timestamp}")
    logger.info(f"test4 duration: {test4_end_timestamp - test4_start_timestamp}")
...
def test_initialize_on_asset_with_custom_credentials(
    ...
    logger.info(f"test5_start_timestamp: {test5_start_timestamp}")
    ...
    logger.info(f"test5_end_timestamp: {test5_end_timestamp}")
    logger.info(f"test5 duration: {test5_end_timestamp - test5_start_timestamp}")


@pytest.mark.integration
def test_initialize_reuse(client, publisher_wallet, consumer_wallet, web3):
    test6_start_timestamp = datetime.now()
    logger.info(f"test6_start_timestamp: {test6_start_timestamp}")
    ...
    logger.info(f"test6_end_timestamp: {test6_end_timestamp}")
    logger.info(f"test6 duration: {test6_end_timestamp - test6_start_timestamp}")
...
def test_can_not_initialize_compute_service_with_simple_initialize(
    ...
    logger.info(f"test7_start_timestamp: {test7_start_timestamp}")
    ...
    logger.info(f"test7_end_timestamp: {test7_end_timestamp}")
    logger.info(f"test7 duration: {test7_end_timestamp - test7_start_timestamp}")
...
def test_initialize_compute_works(
    ...
    logger.info(f"test8_start_timestamp: {test8_start_timestamp}")
    ...
    logger.info(f"test8_end_timestamp: {test8_end_timestamp}")
    logger.info(f"test8 duration: {test8_end_timestamp - test8_start_timestamp}")
...
def test_initialize_compute_order_reused(
    ...
    logger.info(f"test9_start_timestamp: {test9_start_timestamp}")
    ...
    logger.info(f"test9_end_timestamp: {test9_end_timestamp}")
    logger.info(f"test9 duration: {test9_end_timestamp - test9_start_timestamp}")
...
def test_initialize_compute_paid_env(
    ...
    logger.info(f"test10_start_timestamp: {test10_start_timestamp}")
    ddo, alg_ddo = build_and_send_ddo_with_compute_service(
        client,
        publisher_wallet,
        consumer_wallet,
    ...
    logger.info(f"test10_end_timestamp: {test10_end_timestamp}")
    logger.info(f"test10 duration: {test10_end_timestamp - test10_start_timestamp}")


def test_socket():
    test11_start_timestamp = datetime.now()
    logger.info(f"test11_start_timestamp: {test11_start_timestamp}")
    import socket

    s = socket.socket(socket.AF_INET, socket.SOCK_STREAM)

    s.connect(("172.15.0.13", 31000))
    logger.info(f"socket connected successfully to op serv")
    s.send(b"GET / HTTP/1.1\r\nHost:172.15.0.13\r\n\r\n")
    logger.info(f"socket send GET request successfully to op serv")
    response = s.recv(4096)
    s.close()
    logger.info(f"socket closed successfully")
    assert response
    logger.info(f"response from socket op serv: {response.decode()}")
    test11_end_timestamp = datetime.now()
    logger.info(f"test10_end_timestamp: {test11_end_timestamp}")
    logger.info(f"test10 duration: {test11_end_timestamp - test11_start_timestamp}")
