...
from ocean_provider.web3_internal.web3_overrides.contract import CustomContractFunction
...
class ContractBase(object):
    ...
    def subscribe_to_event(self, event_name, timeout, event_filter, callback=None,
        ...
        """
        from ocean_provider.web3_internal.event_listener import EventListener
