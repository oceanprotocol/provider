...
from ocean_provider.web3_internal.utils import (
    add_ethereum_prefix_and_hash_msg,
    generate_multi_value_hash,
    split_signature
)
from ocean_provider.web3_internal.wallet import Wallet
from ocean_provider.web3_internal.web3_overrides.signature import SignatureFix
...
class Web3Helper(object):
    ...
    def send_ether(from_account, to_address, ether_amount):
        ...
        balance = Web3Helper.get_ether_balance(to_address)
        return receipt
